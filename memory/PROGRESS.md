...
当前文件保留最近 8 轮（候选状态机扩展 rejected → pending_review、原创角色 traits 扩充、知名角色 dialogue_style 扩充、daily-pipeline 集成自动导出、daily-pipeline 集成自动审核、今日推荐自动审核闭环、对白模板多样化扩充、概念尾句/标题模式/提示词句式多样化）+ 当前状态。
